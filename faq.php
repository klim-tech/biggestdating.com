...
<head>
	...
	<link href="http://www.biggestdating.com/gzip_loader.php?file=bx_templ_css_cfc823292249d7355a32af5a99abba53.css" rel="stylesheet" type="text/css" />

	<script language="javascript" type="text/javascript" src="http://www.biggestdating.com/gzip_loader.php?file=bx_templ_js_7c19f6f63b7e64870f4d4b470308da35.js"></script>
...
<!-- container-->
 ...
 <!--           <div class="sys_ml_wrapper">-->
	...
	<ul class="sub main_elements">
		<li>
    <a href="http://www.biggestdating.com/faq.php" target="_self"  class="button more_ntop_element active">FAQ</a>
</li><li>
...
<li>
	...
	<!--[if lte IE 6]></td></tr></table></a><![endif]-->
				...
				<div class="clear_both"></div>
				<div class="subMenusContainer" style="width:998px;">			<div class="subMenu" id="subMenu_159" style="display:block">
				<div class="subMenuOvr">

						<table class="subMenuInfoKeeper" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<img class="img_submenu" src="http://www.biggestdating.com/templates/tmpl_tmd027/images/icons/bx_n_help.png" alt="" />								</td>
								<td class="sys_page_header">
								<!-- changed the link and caption to full name on the profile name under menu -->
								<a href="http://www.biggestdating.com/"> </a>
                                <br />
	...
	<div class="input_wrapper input_wrapper_input_set">
		<div class="button_wrapper" style="margin-right: 14px">
			<input class="form_input_submit bigJoinButton submit" type="button" value="Join" name="join" onclick="window.open ('http://www.biggestdating.com/join.php','_self');" />
			...
			<div class="button_wrapper_close">&nbsp;</div>
				...
				<table cellspacing="0" cellpadding="0"><tr>
					<td class="tabbed">
	<table cellspacing="0" cellpadding="0"><tr>
	<td><div style="background:url(http://www.biggestdating.com/templates/base/images/tm_cm_item_left_act.png) no-repeat top left;width:9px;"></div></td>
	<td><div style="background:url(http://www.biggestdating.com/templates/base/images/tm_cm_item_center_act.png) repeat-x top center;">FAQ</div></td>
	<td><div style="background:url(http://www.biggestdating.com/templates/base/images/tm_cm_item_right_act.png) no-repeat top right;width:9px;"></div></td>
	</tr></table>
</td><td class="usual">
	<div><a class="sublinks" href="http://www.biggestdating.com/contact.php"  >Contact</a></div>
</td><td class="usual">
	<div><a class="sublinks" href="http://www.biggestdating.com/advice.php"  >Advice</a></div>
</td>
				</tr></table>
			</div>
			
			<div class="subMenuContainer" style="padding-top:10px; padding-left:10px;">
				<script type="text/javascript"><!--
						google_ad_client = "ca-pub-1091713075063172";
						/* text_links_before_breadcrumb_1 */
						google_ad_slot = "1609990657";
						google_ad_width = 468;
						google_ad_height = 15;
						//-->
						</script>
...
<div class="common">
	...
	<div class="main main_content" style="border:0px; width:998px;">
	...
	<div class="header_r">
	<div class="header_c">
		<div class="boxFirstHeader">FAQ</div>
		</div></div></div>
		<div class="boxContent">
			<div class="clear_both"></div>
				<!-- Design Box [ Start ] here  -->
	<div class="faq_cont">
<div class="faq_header">Is this site free?</div>
<div class="faq_snippet">
Yes. BiggestDating.com is free to use for as long as you wish.
</div>
</div>

<div class="faq_cont">
<div class="faq_header">How do I set my profile picture?</div>
<div class="faq_snippet">
Your profile picture is also called an Avatar. In order to change or set your
avatar, Put your mouse over the Dashboard icon on the main homepage. Click
Avatar, click browse and upload the photo of your choice. If the photo you want
has already been uploaded, just navigate to the photo you want for your Avatar
and under the &quot;Actions&quot; menu, click 'Set as Avatar'.</div></div>

<div class="faq_cont">
<div class="faq_header">Where can I set my privacy options?</div>
<div class="faq_snippet">Click the Dashboard icon from the homepage and choose Privacy Settings. Here you
can customize who has access to all of your data. I recommend changing your
default privacy settings to, at least, members so that non-members cannot access
your information. On your profile page, click the Edit button to customize the
privacy settings on your profile.</div></div>

<div class="faq_cont">
<div class="faq_header">How does the matchmaker work?</div>
<div class="faq_snippet">
The more profile information you enter, the higher the chances of our system
matching you with someone whom your at least 85% compatible with...
</div>
</div>

<div class="faq_cont">
<div class="faq_header">How do I chat with someone?</div>
<div class="faq_snippet">There are several way to chat with another member, the Chat room, simple
messenger, and video messenger. To simple message someone, you can hold your
mouse over the member picture from the home page (allow a few seconds) and it
will give you several options for that members, including chat. You can also
visit the members profile and look under actions where you will see a chat
option and video chat option. Note: The member MUST be online to see chat
options.</div></div>

<div class="faq_cont">
<div class="faq_header">How do I use my webcam in Chat/IM?</div>
<div class="faq_snippet">In order to user your webcam in the Chat room, click the Broadcast Video button
at the bottom right of the chat window. You cannot use your webcam in &quot;simple
messenger&quot;, you will need to click the &quot;Switch to video messenger&quot; in order to
broadcast your webcam.</div></div>


<div class="faq_cont">
<div class="faq_header">How do I upload photos, videos, or music?</div>
<div class="faq_snippet">To upload media, you will need to go to the appropriate menu home option
(Sounds, Photos, or Videos). From there, you will have option buttons at the top
right that say &quot;Add Album&quot; and &quot;My Albums&quot;. If you have not created an album,
click the Add Album button. Create a title name, description, and choose your
privacy level. Once that album and the link to &quot;Add (media type)&quot;. From this
page you will need to choose your up loader version (flash is set by default and
should be fine). Select your file and wait for the upload to finish. You will
need to make sure the title, description, tags and category are set before
selecting submit. Videos uploaded to the site are not immediately available for viewing, they must be processed first.</div></div>

<div class="faq_cont">
<div class="faq_header">Why do I see blue locks that say private in the media galleries?</div>
<div class="faq_snippet">Members have the option to set the privacy level to ALL their media albums. If
you see a blue lock, marked as private, then you do not have permission to view
the media. You can contact that member via email and request permission to view
the media.</div></div>


<div class="faq_cont">
<div class="faq_header">How do I view all the photos that a specific member has?</div>
<div class="faq_snippet">The easiest way to view all photos uploaded by a specific member is to go to
their profile page and scroll down until you see Photo Albums on the left. From
there you can see all the member's photos albums and pictures.</div></div>

<div class="faq_cont">
<div class="faq_header">How can I embed YouTube© Videos?</div>
<div class="faq_snippet">Click the Videos menu option. On the left you will see YOUR video albums. You
can embed into an existing album or choose to create a new one using the steps
above. Enter the album and click Add Video. In Choose Upload, use the drop down
to choose embed. Paste in the URL for the YouTube© video as described and click
continue. Note: You may need to click outside the box for the continue box to
activate. Also, if the video description is too long, the video will not post.</div></div>

<div class="faq_cont">
<div class="faq_header">What is Spy?</div>
<div class="faq_snippet">Spy is an activity feed that shows you what is going on with members at the
site. You have the option to spy all members or just your friends.</div></div>



<div class="faq_cont">
<div class="faq_header">What is the bar at the top of the webpage?</div>
<div class="faq_snippet">This member bar is similar to the one used in Facebook©. It gives you access to
your IM Status, Status Message, Email, Notifications, Friends, Dashboard,
Profile, Your settings, and a logout option.</div></div>

<div class="faq_cont">
<div class="faq_header">What do the Red numbers mean on the member bar?</div>
<div class="faq_snippet">When you see a number on one of the icons (mail, Info (blue circle with the
letter I), or Friends, this means that you have notifications available for
viewing. The number by friends tells you how many friends you currently have
online.</div></div>

<div class="faq_cont">
<div class="faq_header">What is menu tab with the Green + sign?</div>
<div class="faq_snippet">Clicking this menu tab will display additional features or modules available
here at BiggestDating.com.</div></div>


<div class="faq_cont">
<div class="faq_header">How do I post to my Wall?</div>
<div class="faq_snippet">You can click the profile icon from the top menu navigation OR your member bar
(it's the blue man). Choose Wall. From there you can post your message, link,
photo, video, or music to your wall. You can also access your wall from your
profile page.</div></div>

<div class="faq_cont">
<div class="faq_header">How can I edit my profile content?</div>
<div class="faq_snippet">
The default profile content can be edited
<a target="_blank" href="http://www.biggestdating.com/pedit.php">here</a>.</div>

<div class="faq_cont">
<div class="faq_header">How can I upload photos?</div>
<div class="faq_snippet">You can follow this link -
<a href="http://www.biggestdating.com/m/photos/albums/my/add/">Add Photos</a>
</div>
</div>

<div class="faq_cont">
<div class="faq_header">How can I upload videos?</div>
<div class="faq_snippet">
You can follow this link - <a href="http://www.biggestdating.com/m/videos/albums/my/add_objects/">Add
Videos</a></div></div>

<div class="faq_cont">
<div class="faq_header">How can I move my videos around, or change the order they are displayed?</div>
<div class="faq_snippet">
You can follow this link - <a href="http://www.biggestdating.com/m/videos/albums/my/manage_objects/">
Manage
Videos</a></div></div>

<div class="faq_cont">
<div class="faq_header">How can I move my videos around to a different album?</div>
<div class="faq_snippet">
You can follow this link - <a href="http://www.biggestdating.com/m/videos/albums/my/manage_objects/">
Move
Videos</a></div></div>
...
<div class="faq_cont">
<div class="faq_header">How can I upload sounds?</div>
<div class="faq_snippet">
You can follow this link - <a href="http://www.biggestdating.com/m/sounds/albums/my/add_objects/">Add
Sounds</a></div></div>

<div class="faq_cont">
<div class="faq_header">How can I move the music to a different album?</div>
<div class="faq_snippet">
You can follow this link - <a href="http://www.biggestdating.com/m/sounds/albums/my/manage/">
Manage
Sounds</a></div></div>

<div class="faq_cont">
<div class="faq_header">How can I change the order of my music?</div>
<div class="faq_snippet">
You can follow this link - <a href="http://www.biggestdating.com/m/sounds/albums/my/manage/">
Arrange
Sounds</a></div></div>
<!-- Design Box [ End ] here  -->			<div class="clear_both"></div>
		</div>
	</div>
	<div class="clear_both"></div>	
   ...
   <span><a class="bottom_links_block" href="/dating/"  >Blog</a></span>
		...
		<div class="bottomCpr">Copyright &copy; 2012 BiggestDating.com.<!-- 7 5 0 50 8 --></div>
