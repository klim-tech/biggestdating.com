...
<head>
	...
	<link href="http://www.biggestdating.com/gzip_loader.php?file=bx_templ_css_3e2e63498d0e24fb5146ab0ccbfef034.css" rel="stylesheet" type="text/css" />
...
<!-- container-->
 ...
 <!--           <div class="sys_ml_wrapper">-->
    ...
    <a href="http://www.biggestdating.com/privacy.php" target="_self"  class="button more_ntop_element active">Privacy Policy</a>
</li>
		<li class="li_last_round">&nbsp;</li>
	</ul>
	<!--[if lte IE 6]></td></tr></table></a><![endif]--></div>
...
<li>
	...
	<!--[if lte IE 6]></td></tr></table></a><![endif]-->
				...
				<div class="clear_both"></div>
				<div class="subMenusContainer" style="width:998px;">			<div class="subMenu" id="subMenu_120" style="display:block">
				<div class="subMenuOvr">

						<table class="subMenuInfoKeeper" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<img class="img_submenu" src="http://www.biggestdating.com/templates/tmpl_tmd027/images/icons/bx_n_about_us.png" alt="" />								</td>
		...
		<div class="button_wrapper" style="margin-right: 14px">
			...
			<div class="button_wrapper_close">&nbsp;</div>
				...
				<table cellspacing="0" cellpadding="0"><tr>
					<td class="usual">
	<div><a class="sublinks" href="http://www.biggestdating.com/terms_of_use.php"  >Terms of use</a></div>
</td><td class="tabbed">
	<table cellspacing="0" cellpadding="0"><tr>
	...
	<td><div style="background:url(http://www.biggestdating.com/templates/base/images/tm_cm_item_center_act.png) repeat-x top center;">Privacy Policy</div></td>
...
<div class="common">
	...
	<div class="header_r">
	<div class="header_c">
		<div class="boxFirstHeader">Privacy policy</div>
		</div></div></div>
		<div class="boxContent">
			<div class="clear_both"></div>
...
We are glad to welcome you to <site>. Please read this privacy statement to ensure that we are committed to keeping secure the privacy of our members' details.<br><br> 
<b>What information do we collect?</b><br>
Since <site>  is providing you free Online dating services, we may require from you some information that may be considered as personally identifiable.<br><br>
...
We may update our Privacy Statement from time to time so please visit this page regularly.
...
</div><!-- Design Box [ End ] here  -->			<div class="clear_both"></div>
		</div>
	</div>
	<div class="clear_both"></div>	
   ...
   <span><a class="bottom_links_block" href="/dating/"  >Blog</a></span>
		...
		<div class="bottomCpr">Copyright &copy; 2012 BiggestDating.com.<!-- 7 37 0 89 8 --></div>
