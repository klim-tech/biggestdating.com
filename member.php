...
<head>
	...
	<title>BiggestDating.com Login</title>
	...
	<link href="http://www.biggestdating.com/gzip_loader.php?file=bx_templ_css_f6c0eda98c047d042fc8c58b0dca1872.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript">urlIconLoading = "http://www.biggestdating.com/templates/tmpl_tmd027/images/icons/spacer.gif";
	$(document).ready( function() {
		
		var sSendUrl = 'http://www.biggestdating.com/alerts.php';
...
<li>
	...
	<!--[if lte IE 6]></td></tr></table></a><![endif]-->
				...
				<div class="clear_both"></div>
				<div class="subMenusContainer" style="width:998px;">
				</div>
...
<div class="common">
	...
	<div class="header_r">
	<div class="header_c">
		<div class="boxFirstHeader">Login</div>
		</div></div></div>
		<div class="boxContent">
			<div class="clear_both"></div>
				<div class="controlsDiv">
                <form  id="login_box_form" action="http://www.biggestdating.com/member.php" method="post" onsubmit="validateLoginForm(this); return false;" class="form_advanced">
                                <input  class="form_input_hidden" type="hidden" />            <input  class="form_input_hidden" type="hidden" name="relocate" value="http://www.biggestdating.com/member.php" />            <input  class="form_input_hidden" type="hidden" name="csrf_token" value="pZZwR/H8&amp;6fYZwUwxdyE" />
                ...
                <tr >
                    ...
                    <td class="value">
                        <div class="clear_both"></div>
                                        ...
                                        <input  class="form_input_text" type="text" name="ID" />
                    ...
                    <td class="value">
                        <div class="clear_both"></div>
                                        ...
                                        <input  class="form_input_password" type="password" name="Password" />
                    ...
                    <td class="value">
                        <div class="clear_both"></div>
                                        ...
                                        <input  class="form_input_checkbox" type="checkbox" name="rememberMe" id="login_box_form_input_rememberMe" /><label for="login_box_form_input_rememberMe">Remember Me</label>
                ...
                <input  class="form_input_submit" type="submit" name="LogIn" value="Login" />
                <div class="button_wrapper_close"></div>
            </div> 
                        <div class="right_line_aligned">
                            <a href="http://www.biggestdating.com/forgot.php">Forgot password?</a>
                        </div>
                        <div class="clear_both"></div>
                ...
                </form><div class="login_box_text"><div class="usualHeader">Not a member yet? <a href="http://www.biggestdating.com/join.php">Join now!</a></div>Join our dating community now to date singles; Search for other singles in your home town, free video chat, share photos, videos and music chat online and more!</div>
   ...
   <span><a class="bottom_links_block" href="/dating/"  >Blog</a></span>
		...
		<div class="bottomCpr">Copyright &copy; 2012 BiggestDating.com.<!-- 7 18 0 83 8 --></div>
