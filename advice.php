...
<head>
	...
	<link href="http://www.biggestdating.com/gzip_loader.php?file=bx_templ_css_44a042a8ab42d3db39103c38d47e19b0.css" rel="stylesheet" type="text/css" />
...
<!-- container-->
 ...
 <!--           <div class="sys_ml_wrapper">-->
    ...
    <a href="http://www.biggestdating.com/advice.php" target="_self"  class="button more_ntop_element active">Advice</a>
</li>
		<li class="li_last_round">&nbsp;</li>
	</ul>
	<!--[if lte IE 6]></td></tr></table></a><![endif]--></div>
...
<li>
	...
	<td><div style="background:url(http://www.biggestdating.com/templates/base/images/tm_cm_item_center_act.png) repeat-x top center;">Advice</div></td>
...
<div class="common">
	...
	<div class="header_r">
	<div class="header_c">
		<div class="boxFirstHeader">Advice</div>
		</div></div></div>
		<div class="boxContent">
			<div class="clear_both"></div>
				<!-- Design Box [ Start ] here  -->
	<div class="dbContent"><div>
If you have any problems or questions with our site usage, feel free to <a href="http://www.biggestdating.com/contact.php">contact us</a>.
<br /><br />
...
If English isn't your native language, don't be upset if others cannot understand you. You will find friends who speak your language as well, but try to use mostly English.
</div></div><!-- Design Box [ End ] here  -->			<div class="clear_both"></div>
		</div>
	</div>
	<div class="clear_both"></div>	
   ...
   <span><a class="bottom_links_block" href="/dating/"  >Blog</a></span>
		...
		<div class="bottomCpr">Copyright &copy; 2012 BiggestDating.com.<!-- 7 32 0 12 8 --></div>
