...
<head>
	...
	<link href="http://www.biggestdating.com/gzip_loader.php?file=bx_templ_css_4c686883b5eef8096fccbfdd0bb798fb.css" rel="stylesheet" type="text/css" />
...
<!-- container-->
 ...
 <!--           <div class="sys_ml_wrapper">-->
	...
	<ul class="sub main_elements">
		<li>
    <a href="http://www.biggestdating.com/categories.php" target="_self"  class="button more_ntop_element active">All Categories</a>
</li><li>
...
<li>
	...
	<!--[if lte IE 6]></td></tr></table></a><![endif]-->
				...
				<div class="clear_both"></div>
				<div class="subMenusContainer" style="width:998px;">			<div class="subMenu" id="subMenu_91" style="display:block">
				<div class="subMenuOvr">

						<table class="subMenuInfoKeeper" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<img class="img_submenu" src="http://www.biggestdating.com/templates/tmpl_tmd027/images/icons/bx_n_categories.png" alt="" />								</td>
	...
	<td><div style="background:url(http://www.biggestdating.com/templates/base/images/tm_cm_item_center_act.png) repeat-x top center;">All Categories</div></td>
	...
	<div><a class="sublinks" href="http://www.biggestdating.com/categories.php?action=common"  >Common Categories</a></div>
</td><td class="usual">
	<div><a class="sublinks" href="http://www.biggestdating.com/categories.php?action=users"  >User Categories</a></div>
</td><td class="usual">
	<div><a class="sublinks" href="http://www.biggestdating.com/categories.php?action=calendar"  >Calendar</a></div>
</td><td class="usual">
	<div><a class="sublinks" href="http://www.biggestdating.com/categories.php?action=search"  >Search</a></div>
</td>
				</tr></table>
			</div>
...
<div class="common">
	...
	<div id="page_block_1"><div class="disignBoxFirst">
	<div class="boxFirstHeader"><div class="dbTitle">All Categories</div><div id="dbTopMenu1" class="dbTopMenu">
  
  
 <!--    <div class="dbTmLeft">
        <a href="javascript:void(0)" onmouseover="javascript:moveScrollLeftAuto('dbTmContent1', true)" onmouseout="javascript:moveScrollLeftAuto('dbTmContent1', false)">
            <img src="http://www.biggestdating.com/templates/tmpl_tmd027/images/spacer.gif" />
        </a>
    </div> -->
    ...
    <div class="dbTmCenter">
        <div id="dbTmContent1" class="dbTmContent">
   ...
   <!--  <div class="dbTmRight">
        <a href="javascript:void(0)" onmouseover="javascript:moveScrollRightAuto('dbTmContent1', true)" onmouseout="javascript:moveScrollRightAuto('dbTmContent1', false)">
            <img src="http://www.biggestdating.com/templates/tmpl_tmd027/images/spacer.gif" />
        </a>
    </div> -->
    ...
    <script type="text/javascript" language="javascript">
    <!--
        $('#dbTopMenu1').css('top', '-10000px').parents('.disignBoxFirst').ready(function() {
            dbTopMenuLoad('1');
        });        
    -->
    </script>
    ...
    <div class="ordered_block">
        Order by: <select onchange="loadDynamicBlock(1, '/categories.php?tags_mode=bx_photos&action=all&orderby=' + this.value + '')"><option value="none" >None</option><option value="popular" >Popular</option><option value="recent" >Recent</option></select>    </div>
</div><div class="categories_wrapper"><div class="categories_col" style="width: 20%"><a href="m/photos/browse/category/Family">Family(1)</a><br /></div><div class="categories_col" style="width: 20%"><a href="m/photos/browse/category/Fun">Fun(9)</a><br /></div><div class="categories_col" style="width: 20%"><a href="m/photos/browse/category/My+portfolio">My portfolio(12)</a><br /></div><div class="categories_col" style="width: 20%"><a href="m/photos/browse/category/Profile+Photos">Profile Photos(26)</a><br /></div></div><div class="clear_both"></div></div>
   ...
   <span><a class="bottom_links_block" href="/dating/"  >Blog</a></span>
		...
		<div class="bottomCpr">Copyright &copy; 2012 BiggestDating.com.<!-- 7 34 0 1 8 --></div>
