...
/*--- BEGIN: http://www.biggestdating.com//inc/js/join.js---*/
...
$(document).ready(function(){
		...
		{
			var temp_val = $('#blahblah').val();
			$('#blahblah').val(temp_val + '_asd');
		}		
	});
...
function doShowJoinErrors( aErrors, eForm ) {
    ...
    if( bHaveErrors )
	{
		...
		$(".reload_button").trigger("onclick");
		document.join_form.Captcha.value = '';
		check_focus = 0;
...
;
/*--- END: http://www.biggestdating.com//inc/js/join.js---*/
